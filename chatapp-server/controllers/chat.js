...
const sendAttachments = TryCatch(async (req, res, next) => {
  ...
  console.log(`Received attachment request: chatId=${chatId}, files=${files.length}`);
  ...
  try {
    ...
    // Create message object for real-time updates
    ...
    return next(new ErrorHandler(`Error processing attachment: ${error.message}`, 500));
  }
});
